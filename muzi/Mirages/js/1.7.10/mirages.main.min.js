...
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, h, f) {
    if (f.get || f.set)
...
;
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(a, h, f, g) {
    if (h) {
        f = $jscomp.global;
        a = a.split(".");
        ...
        g = f[a];
        h = h(g);
        h != g &amp;&amp; null != h &amp;&amp; $jscomp.defineProperty(f, a, {
            configurable: !0,
            writable: !0,
            value: h
        })
...
$jscomp.checkStringArgs = function(a, h, f) {
    if (null == a)
...
$jscomp.polyfill("String.prototype.endsWith", function(a) {
    return a ? a : function(a, f) {
        var g = $jscomp.checkStringArgs(this, a, "endsWith");
        a += "";
        void 0 === f &amp;&amp; (f = g.length);
        for (var k = Math.max(0, Math.min(f | 0, g.length)), h = a.length; 0 &lt; h &amp;&amp; 0 &lt; k; )
            if (g[--k] != a[--h])
                return !1;
        return 0 &gt;= h
    }
...
(function(a) {
    var h = 0
      , f = !1
      , g = {};
    "touchmove"in document.createElement("div") &amp;&amp; (f = !0);
    a(document).ready(function() {
        ...
        a(window).bind("scroll", function(b) {
            b = a("#wrap");
            b.find("#nav").width() &lt; h &amp;&amp; (LocalConst.IS_MOBILE &amp;&amp; f || !LocalConst.IS_MOBILE) &amp;&amp; (a("#wrap.display-nav").find("#body").unbind("click"),
        ...
        LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_EMBED &amp;&amp; A();
        B()
    });
    ...
    var k = {}
      ...
      , ba = function(a, c) {
        var b = document.body, e = document.documentElement, n = function() {
        ...
        (function aa() {
            ...
            b.onElementHeightChangeTimer = setTimeout(aa, a)
        }
        )()
    }
      , T = function() {
      ...
      , V = function() {
        a("#toggle-nav").off("click").on("click", function(b) {
            ...
            var e = a("#nav-toolbar").find(".side-toolbar");
            e.removeClass("show-read-settings");
            ...
            setTimeout(function() {
                var b = a("#body");
                b.off("click").on("click", function(n) {
                    b.off("click");
                ...
                b.off("touchmove").on("touchmove", function(n) {
                    b.off("click");
                    c.removeClass("display-nav").removeClass("hide-menu-tree");
                    d.removeClass("display-nav");
                    LocalConst.TOC_AT_LEFT || (a("#wrap").removeClass("display-menu-tree"),
      ...
      , B = function() {
        if (LocalConst.ENABLE_PJAX)
            a("#comment-form").off("submit").on("submit", function(b) {
                var c = a(this)
                  , d = c.find("#submit")
                  , e = c.parents(".respond").parent()
                  , n = c.find("#author").val();
                b = c.find("#url").val();
                var l = c.find("#textarea").val();
                if (null === l || "" === a.trim(l))
                    return alert(d.attr("data-empty-comment")),
                    !1;
                0 === c.find("#author").length &amp;&amp; 0 === c.find("#url").length &amp;&amp; (n = a('a[href$="profile.php"]').text(),
                b = document.location.origin);
                d.attr("disabled", "disabled").val(d.attr("data-posting"));
                var f = "newComment-" + D;
                D++;
                b = '&lt;li itemscope="" itemtype="http://schema.org/UserComments" id="' + f + '" class="comment-body"&gt;&lt;div class="comment-author" itemprop="creator" itemscope="" itemtype="http://schema.org/Person"&gt;&lt;span itemprop="image"&gt;&lt;img class="avatar" src="' + LocalConst.BASE_SCRIPT_URL + 'images/spinner.svg" alt="' + n + '" width="100" height="100"&gt;&lt;/span&gt;&lt;cite class="fn color-main" itemprop="name"&gt;&lt;a href="' + b + '" rel="external nofollow" target="_blank"&gt;' + n + '&lt;/a&gt;&lt;/cite&gt;&lt;/div&gt;&lt;div class="comment-meta"&gt;&lt;a href="javascript:void(0)"&gt;&lt;time itemprop="commentTime" datetime="' + d.attr("data-now") + '"&gt;' + d.attr("data-now") + '&lt;/time&gt;&lt;/a&gt;&lt;span id="' + f + '-status" class="comment-posting"&gt;' + d.attr("data-posting") + '&lt;/span&gt;&lt;/div&gt;&lt;div class="comment-content" itemprop="commentText"&gt;&lt;p&gt;' + t(ca(l), g.owoData) + "&lt;/p&gt;&lt;/div&gt;&lt;/li&gt;";
                var r = l = !1
                  , h = "DESC" === LocalConst.COMMENTS_ORDER;
                e.is("div") &amp;&amp; "comments" === e.attr("id") ? (0 &lt; e.children(".comment-list").length ? h ? e.children(".comment-list").first().prepend(b) : e.children(".comment-list").first().append(b) : (e.append('&lt;div class="comment-separator"&gt;&lt;div class="comment-tab-current"&gt;&lt;span class="comment-num"&gt;\u5df2\u6709 1 \u6761\u8bc4\u8bba&lt;/span&gt;&lt;/div&gt;&lt;/div&gt;'),
                e.append('&lt;ol class="comment-list"&gt;' + b + "&lt;/ol&gt;"),
                r = !0),
                l = !0) : e.is("li") &amp;&amp; e.hasClass("comment-body") &amp;&amp; (e.parent().parent().is("div") &amp;&amp; "comments" === e.parent().parent().attr("id") ? 0 &lt; e.children(".comment-children").first().children(".comment-list").length ? e.children(".comment-children").first().children(".comment-list").first().append(b) : e.append('&lt;div class="comment-children" itemprop="discusses"&gt;&lt;ol class="comment-list"&gt;' + b + "&lt;/ol&gt;&lt;/div&gt;") : e.parents(".comment-list").first().append(b),
                l = !0);
                if (l) {
                    var k = w();
                    try {
                        var p = a("#" + f).offset();
                        "undefined" !== typeof p &amp;&amp; a("html, body").animate({
                            scrollTop: p.top - 50 - k
                        }, 300)
                    } catch (x) {
                        console.error(x)
                    }
                    var m = function() {
                        try {
                            r ? (e.children(".comment-separator").first().remove(),
                            e.children(".comment-list").first().remove()) : a("#" + f).remove();
                        ...
                        a.ajax({
                            ...
                            success: function(b) {
                                ...
                                if (0 &lt; b.indexOf("&lt;title&gt;Error&lt;/title&gt;")) {
                                    var e = a("&lt;div&gt;&lt;/div&gt;");
                                    e.html(b);
                                    alert(a.trim(a(".container", e).text()));
                                    m()
                                } else if (c.find("#textarea").val(""),
                                "undefined" !== typeof TypechoComment &amp;&amp; TypechoComment.cancelReply(),
                                e = b.match(/id="comment-\d+"/g),
                                null === e || 0 === e.length)
                                    window.location.reload();
                                else {
                                    var e = e.join().match(/\d+/g).sort(function(a, b) {
                                        return a - b
                                    }).pop()
                                      , l = a("&lt;div&gt;&lt;/div&gt;");
                                    l.html(b);
                                    b = a("#comment-" + e, l);
                                    a.trim(b.children(".comment-author").find("cite.fn").text()) === a.trim(n) ? (b.children(".comment-meta").append('&lt;span id="comment-' + e + '-status" class="comment-posted"&gt;' + d.attr("data-posted") + "&lt;/span&gt;"),
                                    l = b.children(".comment-content"),
                                    l.html(t(l.html(), g.owoData)),
                                    a("#" + f).replaceWith(b),
                                    Mlog("#comment-" + e + " img.avatar[data-src]"),
                                    a("#comment-" + e + " img.avatar[data-src]").each(function() {
                                        var b = a(this);
                                        F(b)
                                    })) : a("#" + f + "-status").text(d.attr("data-posted")).removeClass("comment-posting").addClass("comment-posted")
                                }
        ...
        if (LocalConst.SHOW_TOC) {
            ...
            a('a.index-menu-link[href^="#menu_index_"]').each(function() {
                ...
                b.match(/menu_index_\d+/) &amp;&amp; (a(this).off("click").on("click", function() {
                    v = !1;
                    G(a(this));
                    H(b.substring(1), !0, function() {
                        v = !0;
                        u()
                    });
                    1E3 &gt; window.innerWidth &amp;&amp; (a("#wrap").removeClass("display-menu-tree").removeClass("display-nav"),
                    a("body").removeClass("display-menu-tree").removeClass("display-nav"))
                }),
                k[parseInt(a(b).offset().top)] = b)
            });
            m = Object.keys(k);
      ...
      , fa = function() {
        LocalConst.SHOW_TOC &amp;&amp; (k = {},
        a('a.index-menu-link[href^="#menu_index_"]').each(function() {
            var b = a(this).attr("href");
            b.match(/menu_index_\d+/) &amp;&amp; (k[parseInt(a(b).offset().top)] = b)
        }),
        m = Object.keys(k),
      ...
      , u = function() {
        if (LocalConst.SHOW_TOC &amp;&amp; v) {
            var b = w()
              , b = a(window).scrollTop() + 100 + b;
            20 &lt; b &amp;&amp; a("#toggle-menu-tree").removeClass("revert");
            if (a("#wrap").hasClass("display-menu-tree")) {
                for (var c = 0, d = 0; d &lt; m.length; d++) {
                    var e = m[d];
                    if (e &lt;= b)
                        c = k[e];
                    else
      ...
      , t = function(a, c) {
        var b, e = "";
        for (void 0 !== window.devicePixelRatio &amp;&amp; 1.49 &lt;= window.devicePixelRatio &amp;&amp; (e = "_2x"); b = a.match(/@\(\s*(\u5475\u5475|\u54c8\u54c8|\u5410\u820c|\u592a\u5f00\u5fc3|\u7b11\u773c|\u82b1\u5fc3|\u5c0f\u4e56|\u4e56|\u6342\u5634\u7b11|\u6ed1\u7a3d|\u4f60\u61c2\u7684|\u4e0d\u9ad8\u5174|\u6012|\u6c57|\u9ed1\u7ebf|\u6cea|\u771f\u68d2|\u55b7|\u60ca\u54ed|\u9634\u9669|\u9119\u89c6|\u9177|\u554a|\u72c2\u6c57|what|\u7591\u95ee|\u9178\u723d|\u5440\u54a9\u7239|\u59d4\u5c48|\u60ca\u8bb6|\u7761\u89c9|\u7b11\u5c3f|\u6316\u9f3b|\u5410|\u7280\u5229|\u5c0f\u7ea2\u8138|\u61d2\u5f97\u7406|\u52c9\u5f3a|\u7231\u5fc3|\u5fc3\u788e|\u73ab\u7470|\u793c\u7269|\u5f69\u8679|\u592a\u9633|\u661f\u661f\u6708\u4eae|\u94b1\u5e01|\u8336\u676f|\u86cb\u7cd5|\u5927\u62c7\u6307|\u80dc\u5229|haha|OK|\u6c99\u53d1|\u624b\u7eb8|\u9999\u8549|\u4fbf\u4fbf|\u836f\u4e38|\u7ea2\u9886\u5dfe|\u8721\u70db|\u97f3\u4e50|\u706f\u6ce1|\u5f00\u5fc3|\u94b1|\u54a6|\u547c|\u51b7|\u751f\u6c14|\u5f31|\u5410\u8840)\s*\)/); )
            a = a.replace(b[0], '&lt;img src="' + LocalConst.BIAOQING_PAOPAO_PATH + encodeURI(b[1]).replace(/%/g, "") + e + '.png" class="biaoqing newpaopao" height=30 width=30 no-zoom /&gt;');
        for (; b = a.match(/#\(\s*(\u9ad8\u5174|\u5c0f\u6012|\u8138\u7ea2|\u5185\u4f24|\u88c5\u5927\u6b3e|\u8d5e\u4e00\u4e2a|\u5bb3\u7f9e|\u6c57|\u5410\u8840\u5012\u5730|\u6df1\u601d|\u4e0d\u9ad8\u5174|\u65e0\u8bed|\u4eb2\u4eb2|\u53e3\u6c34|\u5c34\u5c2c|\u4e2d\u6307|\u60f3\u4e00\u60f3|\u54ed\u6ce3|\u4fbf\u4fbf|\u732e\u82b1|\u76b1\u7709|\u50bb\u7b11|\u72c2\u6c57|\u5410|\u55b7\u6c34|\u770b\u4e0d\u89c1|\u9f13\u638c|\u9634\u6697|\u957f\u8349|\u732e\u9ec4\u74dc|\u90aa\u6076|\u671f\u5f85|\u5f97\u610f|\u5410\u820c|\u55b7\u8840|\u65e0\u6240\u8c13|\u89c2\u5bdf|\u6697\u5730\u89c2\u5bdf|\u80bf\u5305|\u4e2d\u67aa|\u5927\u56e7|\u5472\u7259|\u62a0\u9f3b|\u4e0d\u8bf4\u8bdd|\u54bd\u6c14|\u6b22\u547c|\u9501\u7709|\u8721\u70db|\u5750\u7b49|\u51fb\u638c|\u60ca\u559c|\u559c\u6781\u800c\u6ce3|\u62bd\u70df|\u4e0d\u51fa\u6240\u6599|\u6124\u6012|\u65e0\u5948|\u9ed1\u7ebf|\u6295\u964d|\u770b\u70ed\u95f9|\u6247\u8033\u5149|\u5c0f\u773c\u775b|\u4e2d\u5200)\s*\)/); )
            a = a.replace(b[0], '&lt;img src="' + LocalConst.BIAOQING_ARU_PATH + encodeURI(b[1]).replace(/%/g, "") + e + '.png" class="biaoqing alu" height=33 width=33 no-zoom /&gt;');
        a = ga(a, c);
      ...
      , ga = function(a, c) {
        if ("undefined" !== typeof c)
            return a = a.replace(/::([^:]+):([^:]+)::/g, function(a, b, n) {
                var d = c[b];
                if ("undefined" === typeof d || !d.icons.includes(n))
                    return a;
                a = LocalConst.BASE_SCRIPT_URL + "usr/biaoqing/" + d.name + "/";
                var e = d.suffix;
                void 0 != window.devicePixelRatio &amp;&amp; 1.49 &lt;= window.devicePixelRatio &amp;&amp; (e = d.retinaSuffix);
                return '&lt;img src="' + (a + n + e) + '" class="' + ("biaoqing " + d.imgClass) + '" alt="' + (b + " " + n) + '"&gt;'
            })
    }
      , A = function() {
        var b = document.getElementsByClassName("OwO")[0]
          , c = document.getElementById("textarea")
          , d = function(b) {
            for (var c = {}, d = 0; d &lt; b.packages.length; d++)
                if ("usr" === b.odata[b.packages[d]].type) {
                    for (var e = b.odata[b.packages[d]], f = e.container, h = [], k = 0; k &lt; f.length; k++) {
                        var p = f[k];
                        "undefined" !== typeof p &amp;&amp; ("string" === typeof p ? h.push(p) : "string" === typeof p.icon &amp;&amp; h.push(p.icon))
                    }
                    e.icons = h;
                    c[e.name] = e
                }
            ...
            "undefined" !== typeof MathJax &amp;&amp; MathJax.Hub.Queue(["Typeset", MathJax.Hub, "body"])
        };
      ...
      , X = function() {
        ...
        a("a.background-color-control").off("click").on("click", function(c) {
            ...
            if ("auto" === c) {
                c = a("#side-toolbar-night-shift");
                LocalConst.AUTO_NIGHT_SHIFT = !0;
                var d = (new Date).getHours();
                5 &gt;= d || 22 &lt;= d || LocalConst.PREFERS_DARK_MODE ? (b.removeClass("theme-white").removeClass("theme-sunset").addClass("theme-dark"),
                c.addClass("night"),
                c = "theme-dark") : (b.removeClass("theme-dark").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),
                c = "theme-white");
                q("MIRAGES_NIGHT_SHIFT_MODE", "AUTO");
                b.trigger("mirages:theme-change", [{
                    auto: !0,
                    theme: c
                }])
            } else
                "white" === c ? (b.removeClass("theme-dark").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),
                q("MIRAGES_NIGHT_SHIFT_MODE", "DAY"),
                LocalConst.AUTO_NIGHT_SHIFT = !1,
                b.trigger("mirages:theme-change", [{
                    auto: !1,
                    theme: "theme-white"
                }])) : "sunset" === c ? (b.removeClass("theme-dark").addClass(LocalConst.LIGHT_THEME_CLASS).addClass("theme-sunset"),
                q("MIRAGES_NIGHT_SHIFT_MODE", "SUNSET"),
                LocalConst.AUTO_NIGHT_SHIFT = !1,
                b.trigger("mirages:theme-change", [{
                    auto: !1,
                    theme: "theme-sunset"
                }])) : "dark" === c &amp;&amp; (b.removeClass("theme-white").removeClass("theme-sunset").addClass("theme-dark"),
                q("MIRAGES_NIGHT_SHIFT_MODE", "NIGHT"),
                LocalConst.AUTO_NIGHT_SHIFT = !1,
                b.trigger("mirages:theme-change", [{
                    auto: !1,
                    theme: "theme-dark"
      ...
      , Y = function() {
        a("button.font-family-control").off("click").on("click", function(b) {
            ...
            if ("serif" === b) {
                q("MIRAGES_USE_SERIF_FONTS", "1");
                if (!g.serifFontLoaded) {
                ...
                "sans-serif" === b &amp;&amp; (q("MIRAGES_USE_SERIF_FONTS", ""),
      ...
      , Z = function() {
        ...
        (function() {
            ...
            console.log(LocalConst.ROOT_FONT_SIZE));
            c = Math.round(c);
            b.text(c + "%")
        }
        )();
      ...
      , I = function() {
        a("section.lazy-load").each(function() {
            0 &lt;= window.asyncImageLoadNum &amp;&amp; (window.asyncImageLoadNum++,
            Mlog("Loading..." + window.asyncImageLoadNum));
            var b = a(this)
              , c = b.find(".progressiveMedia")
              , d = c.find(".img-small")
              , e = b.attr("data-" + LocalConst.KEY_CDN_TYPE)
              , e = getImageAddon(e)
              , f = new Image;
            f.src = d.attr("data-src") + e;
            f.classList.add("img-large");
            a(f).attr("no-zoom", !0);
            f.onload = function() {
                c.addClass("large-image-loaded");
                setTimeout(function() {
                    a(f).addClass("loaded").attr("data-action", "zoom").removeAttr("no-zoom").removeAttr("width").removeAttr("height").css("height", "").attr("data-shadow", b.attr("data-shadow"));
                    b.replaceWith(a(f));
                    0 &lt;= window.asyncImageLoadCompleteNum &amp;&amp; (window.asyncImageLoadCompleteNum++,
                    Mlog("Loaded: " + window.asyncImageLoadCompleteNum),
                    window.asyncImageLoadCompleteNum === window.asyncImageLoadNum &amp;&amp; (window.asyncImageLoadNum = -1170,
        ...
        isNaN(window.asyncImageLoadNum) || 0 !== window.asyncImageLoadNum || (Mlog("Async Image Nothing to Load"),
      ...
      , M = function(a) {
        if (!a)
            return 0;
        var b = L(a, "transition-duration");
        a = L(a, "transition-delay");
        var d = parseFloat(b)
          , e = parseFloat(a);
        if (!d &amp;&amp; !e)
            return 0;
      ...
      , N = function() {
        var a = [].slice.call(document.querySelectorAll('[data-mirages-toggle="collapse"]'));
        [].forEach.call(a, function(a) {
            a.addEventListener("click", function(b) {
                ...
                var c = function(a, b) {
                  ...
                  , d = document.querySelector(a.dataset.target);
                d.classList.contains("show") ? c(a, d) : b(a, d)
            });
            var b = document.querySelector(a.dataset.target);
      ...
      , ja = function() {
        try {
            ...
            a(".post-content embed:not([not-video], [height], .video-4-3, .video-16-9, .large-content), .post-content video:not([not-video], [height], .video-4-3, .video-16-9, .large-content), .post-content iframe:not([not-video], [height], .video-4-3, .video-16-9, .large-content)").addClass("video-4-3"),
      ...
      , ka = function() {
        a(".content-tab-title").off("click").on("click", function(b) {
            var c = a(this)
              , d = c.parent();
            b = d.parent();
            var e = c.attr("data-tab-index");
            b.find(".content-tab-title").each(function() {
                a(this).attr("data-tab-index") === e ? a(this).addClass("selected") : a(this).removeClass("selected")
            });
      ...
      , P = function() {
        ...
        LocalConst.HIDE_CODE_LINE_NUMBER || ha();
      ...
      , Q = function() {
        if (LocalConst.ENABLE_FLOW_CHART) {
            var b = function() {
                var b = 2;
                void 0 !== window.devicePixelRatio &amp;&amp; 1.49 &lt;= window.devicePixelRatio &amp;&amp; (b = 1.5);
                var d = {
                    x: 0,
                    y: 0,
                    "line-width": b,
                ...
                d["font-color"] = "white",
                b = "dark");
                g.flowChartTheme === b ? Mlog("FlowChart Theme Not Change. Skip Render...") : (g.flowChartTheme = b,
                a("pre&gt;code.lang-flow").each(function() {
                    ...
                    if ("undefined" !== typeof c)
                        try {
                            var b = "flow-chart-" + b
                              , f = flowchart.parse(c)
                              , g = document.querySelector("#" + b);
                            g ? (g.innerHTML = "",
                            f.drawSVG(b, d)) : console.warn("FlowChart Target: " + b + " Not Exists!")
                        } catch (r) {
                            console.error(r)
                        }
                }))
                        ...
                        if ("undefined" !== typeof c)
                            try {
                                ...
                                mermaid.mermaidAPI.render(d, c, function(a, b) {
                                    ...
                                    var e = c.getAttribute("viewBox");
                                    if (e) {
                                        if (e = e.split(/\s+/),
                                        4 === e.length) {
                                            var g = parseInt(e[0], 10)
                                              , e = parseInt(e[2], 10) - g;
                                            0 &lt; e &amp;&amp; (c.style.maxWidth = e + "px",
                                            c.style.minWidth = .75 * e + "px")
                                        }
                                    } else
                                        e = .75 * parseInt(c.style.maxWidth, 10),
                                        0 &lt; e &amp;&amp; (c.style.minWidth = e + "px")
                                })
                            } catch (r) {
                                console.error(r),
                                (c = document.querySelector("#d" + d)) &amp;&amp; remove(c)
                            }
                    })
                }
            };
    ...
    window.Mirages = {
        ...
        doPJAXCompleteAction: function() {
            ...
            isNaN(window.asyncBannerLoadNum) || 0 !== window.asyncBannerLoadNum || (Mlog("Async Banner Nothing to Load"),
            ...
            0 &gt; b || (b = window.location.hash.substring(b + 1),
            H(b));
            y();
            N();
            Q();
            ...
            if ("undefined" !== typeof dPlayerOptions &amp;&amp; "undefined" !== typeof dPlayers)
                ...
                c = 0; c &lt; b; c++)
                    d = document.getElementById("player" + dPlayerOptions[c].id),
            ...
            LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_DISQUS ? K() : LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_EMBED &amp;&amp; (B(),
            A())
        }
    };
...
!function(e) {
    ...
    function k(e, t, c, r) {
        ...
        try {
            ...
            if (e$1.message &amp;&amp; -1 !== e$1.message.indexOf("Illegal"))
                return {
                    r: 0,
                    value: y(t)
                };
